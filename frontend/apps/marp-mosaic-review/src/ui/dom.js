...
/* `initialsOf` was here, and the account menu it drew for is now one shared component
   (#151): `frontend/shared/assets/js/account-menu.js` draws the initials for this app, the
   ML Dashboard and the landing page alike. The warning it carried still holds and now holds
   in one place -- no name is a literal in this application, and `state.me` is the only
