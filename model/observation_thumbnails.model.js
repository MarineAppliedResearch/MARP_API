 ...
 * asked for* -- and is never written. A row is created when the observation is
 * created (A3, reversed 2026-09-10), so absence means the observation predates
 * that and nothing is coming for it: it reports **`failed`** to the client, which
 * draws NO IMAGE and offers an *Ask again* that works. #121 is the sweeper.
 *
 * Refs #118.
 *
