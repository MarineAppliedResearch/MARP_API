...
module.exports = {
  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable(
        'species',
        {
          ...
          created_at: {
            ...
            comment: 'Timestamp when this species record was created.',
          },
          ...
          updated_at: {
            ...
            allowNull: false,
            defaultValue: Sequelize.NOW,
            comment: 'Timestamp when this species record was last updated.',
          },
        },
        {
          transaction, // ensure this table creation is part of the transaction
          comment:
            'Taxonomic and GUI configuration table for species used in MARP observations, reports, and ML models.',
        }
    );

    // Indexes — all inside the same transaction
    ...
    await queryInterface.addIndex('species', ['comname'], {
      name: 'species_comname_idx',
      transaction,
    });

    await queryInterface.addIndex('species', ['report_group'], {
      name: 'species_report_group_idx',
      transaction,
    });

    await queryInterface.addIndex('species', ['gui_maintab'], {
      name: 'species_gui_maintab_idx',
      transaction,
    });

    await queryInterface.addIndex('species', ['gui_subtab'], {
    ...
    await queryInterface.createTable(
      'datasets',
      {
        ...
        name: {
          type: Sequelize.STRING,
          allowNull: false,
          comment: 'Descriptive name of this dataset (e.g., "Fish_2024_Training_Set_v1").',
        },
        ...
        num_classes: {
          ...
          allowNull: true,
          comment:
            'Approximate number of unique species/classes represented in this dataset (derived from observation comnames).',
        },
        ...
        notes: {
          ...
          allowNull: true,
          comment:
            'General notes about dataset preparation, inclusion criteria, or issues.',
        },
    ...
    await queryInterface.addIndex('datasets', ['source'], {
    ...
    await queryInterface.createTable(
      'ml_models',
      {
        id: {
          ...
          autoIncrement: true,
          primaryKey: true,
          comment: 'Unique numeric identifier for this ML model record.',
        },

        name: {
          type: Sequelize.STRING,
          allowNull: false,
          comment: 'Human-readable name (e.g., "yolov8-marine-fish-2025").',
        },
        ...
        parent_model_id: {
          ...
          onUpdate: 'NO ACTION',
          onDelete: 'SET NULL', // keep child; just clear lineage if parent deleted
          comment: 'Optional self-reference for lineage.',
        },

        model_type: {
          type: Sequelize.STRING,
          allowNull: false,
          comment: 'Architecture family (e.g., "yolov8", "resnet").',
        },

        architecture_version: {
          type: Sequelize.STRING,
          allowNull: true,
          comment: 'Architecture variant/version (e.g., "v8n", "2025a").',
        },

        storage_path: {
          type: Sequelize.STRING,
          allowNull: true,
          comment: 'Path/URI to weights and artifacts.',
        },
        ...
        status: {
          ...
          allowNull: false,
          defaultValue: 'draft',
          comment: 'Lifecycle: "draft" | "training" | "trained" | "archived".',
        },
    ...
    // Non-unique index on name (matches your model)
    await queryInterface.addIndex('ml_models', ['name'], {
    ...
    await queryInterface.createTable(
      'training_runs',
      {
        ...
        model_id: {
          ...
          references: { model: 'ml_models', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'CASCADE', // if model deleted, remove its runs
    ...
    // Indexes
    await queryInterface.addIndex('training_runs', ['model_id'], {
      name: 'training_runs_model_id_idx',
      transaction
    });
    await queryInterface.addIndex('training_runs', ['dataset_id'], {
      name: 'training_runs_dataset_id_idx',
      transaction
    });
    await queryInterface.addIndex('training_runs', ['start_time'], {
    ...
    await queryInterface.createTable(
      'epochs',
      {
        ...
        training_run_id: {
          type: Sequelize.INTEGER,
          allowNull: false,
          references: { model: 'training_runs', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'CASCADE', // delete epochs when training run is deleted
          comment:
        ...
        start_time: {
          type: Sequelize.DATE,
          allowNull: true,
          comment: 'Timestamp marking when this epoch began processing.',
        },

        end_time: {
          type: Sequelize.DATE,
          allowNull: true,
          comment: 'Timestamp marking when this epoch completed.',
        },
        ...
        precision: {
          type: Sequelize.FLOAT,
          allowNull: true,
          comment: 'Precision metric value recorded at the end of this epoch.',
        },

        recall: {
          type: Sequelize.FLOAT,
          allowNull: true,
          comment: 'Recall metric value recorded at the end of this epoch.',
        },
        ...
        timestamp: {
          ...
          allowNull: true,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this epoch record was inserted into the database.',
        },
        ...
        created_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this epoch record was created.',
        },
        ...
        updated_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this epoch record was last updated.',
        },
      },
    ...
    // Indexes
    await queryInterface.addIndex('epochs', ['training_run_id'], {
      name: 'epochs_training_run_id_idx',
      transaction
    });
    await queryInterface.addIndex('epochs', ['epoch_number'], {
      name: 'epochs_epoch_number_idx',
      transaction
    });
    await queryInterface.addIndex('epochs', ['start_time'], {
    ...
    await queryInterface.createTable(
      'metrics_summary',
      {
        ...
        training_run_id: {
          ...
          references: { model: 'training_runs', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'CASCADE', // removing a training run removes its summaries
          comment:
        ...
        precision: {
          type: Sequelize.FLOAT,
          allowNull: true,
          comment: 'Aggregate precision achieved for this dataset split.',
        },

        recall: {
          type: Sequelize.FLOAT,
          allowNull: true,
          comment: 'Aggregate recall achieved for this dataset split.',
        },

        map50: {
          type: Sequelize.FLOAT,
          allowNull: true,
          comment: 'Mean Average Precision (mAP) at 0.5 IoU threshold for this split.',
        },
        ...
        confusion_matrix_norm_path: {
          ...
          allowNull: true,
          comment:
            'Path to the normalized confusion matrix plot image generated during evaluation.',
        },
        ...
        labels_plot_path: {
          ...
          allowNull: true,
          comment:
            'Path to the label distribution plot image showing class balance in the dataset.',
        },
    ...
    // Indexes
    await queryInterface.addIndex('metrics_summary', ['training_run_id'], {
      name: 'metrics_summary_training_run_id_idx',
      transaction
    });
    await queryInterface.addIndex('metrics_summary', ['dataset_split'], {
    ...
    await queryInterface.createTable(
      'metrics_curves',
      {
        ...
        metrics_summary_id: {
          type: Sequelize.INTEGER,
          allowNull: false,
          references: { model: 'metrics_summary', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'CASCADE', // delete curves when summary is deleted
          comment:
        ...
        species_id: {
          ...
          references: { model: 'species', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'NO ACTION', // species deletion does not affect curves
          comment:
            'Foreign key referencing the species this summary applies to. NULL means it represents an aggregate across all species.',
        },
        ...
        created_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this metrics curve record was created.',
        },
        ...
        updated_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this metrics curve record was last updated.',
        },
      },
    ...
    // Indexes
    await queryInterface.addIndex('metrics_curves', ['metrics_summary_id'], {
      name: 'metrics_curves_summary_id_idx',
      transaction
    });
    
    await queryInterface.addIndex('metrics_curves', ['confidence_threshold'], {
    ...
    await queryInterface.createTable(
      'model_species',
      {
        ...
        model_id: {
          ...
          references: { model: 'ml_models', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'CASCADE', // delete links when model is deleted
          comment:
        ...
        species_id: {
          ...
          references: { model: 'species', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'NO ACTION', // species deletion leaves links intact
          comment:
        ...
        created_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this model-species record was created.',
        },
        ...
        updated_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this model-species record was last updated.',
        },
      },
    ...
    // Indexes
    await queryInterface.addIndex('model_species', ['model_id'], {
      name: 'model_species_model_id_idx',
      transaction
    });
    
    await queryInterface.addIndex('model_species', ['species_id'], {
      name: 'model_species_species_id_idx',
      transaction
    });

    await queryInterface.addIndex('model_species', ['model_id', 'species_id'], {
      ...
      await queryInterface.createTable(
        'artifacts',
        {
          ...
          training_run_id: {
            ...
            references: { model: 'training_runs', key: 'id' },
            onUpdate: 'NO ACTION',
            onDelete: 'CASCADE', // delete artifacts when their training_run is deleted
            comment:
        ...
        {
          transaction, // ✅ ensures this createTable is in the overall migration transaction
          comment:
            'Tracks files and outputs produced during a training run, including weights, logs, and result visualizations.',
        }
      );

      // Indexes — all inside same transaction
      await queryInterface.addIndex('artifacts', ['training_run_id'], {
        name: 'artifacts_training_run_id_idx',
        transaction,
      });

      await queryInterface.addIndex('artifacts', ['artifact_type'], {
        name: 'artifacts_artifact_type_idx',
        transaction,
      });

      await queryInterface.addIndex('artifacts', ['path'], {
    ...
    await queryInterface.createTable(
      'hyperparameters',
      {
        ...
        training_run_id: {
          ...
          references: { model: 'training_runs', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'CASCADE', // delete when training_run deleted
          comment:
        ...
        created_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this hyperparameter record was created.',
        },
        ...
        updated_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this hyperparameter record was last updated.',
        },
      },
      {
        transaction, // ✅ ensure part of the migration transaction
        comment:
    ...
    // Indexes — all inside the same transaction
    await queryInterface.addIndex('hyperparameters', ['training_run_id'], {
      name: 'hyperparameters_training_run_id_idx',
      transaction,
    });


    // 11. dataset_observations
    // Inside your `up()` function
    await queryInterface.createTable(
      'dataset_observations',
      {
        ...
        dataset_id: {
          ...
          references: { model: 'datasets', key: 'id' },
          onUpdate: 'NO ACTION',
          onDelete: 'CASCADE', // remove join records if dataset deleted
          comment:
        ...
        observation_id: {
          ...
          onUpdate: 'NO ACTION',
          onDelete: 'NO ACTION', // remove join records if observation deleted
          comment:
        ...
        created_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this dataset-observation record was created.',
        },
        ...
        updated_at: {
          ...
          allowNull: false,
          defaultValue: Sequelize.NOW,
          comment: 'Timestamp when this dataset-observation record was last updated.',
        },
      },
      {
        transaction, // ✅ ensure table creation is part of the migration transaction
        comment:
    ...
    // Indexes — all inside the same transaction
    await queryInterface.addIndex('dataset_observations', ['dataset_id'], {
      name: 'dataset_observations_dataset_id_idx',
      transaction,
    });

    await queryInterface.addIndex('dataset_observations', ['observation_id'], {
      name: 'dataset_observations_observation_id_idx',
      transaction,
    });

    await queryInterface.addIndex('dataset_observations', ['dataset_id', 'observation_id'], {
  ...
  async down(queryInterface) {
    ...
    try {
      ...
      await queryInterface.dropTable('model_species', { transaction });
      await queryInterface.dropTable('metrics_curves', { transaction });
      await queryInterface.dropTable('metrics_summary', { transaction });
      await queryInterface.dropTable('epochs', { transaction });
      await queryInterface.dropTable('training_runs', { transaction });
      await queryInterface.dropTable('ml_models', { transaction });
      await queryInterface.dropTable('datasets', { transaction });
      await queryInterface.dropTable('species', { transaction });
